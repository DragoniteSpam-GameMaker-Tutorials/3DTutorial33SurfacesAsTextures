...
function c_init() {
	...
	This is a wrapper of the Bullet 3D collision system for GameMaker.
	The original work was done by a user called Venomous on the old GameMaker forums;
	the version you're seeing now was cleaned up by DragoniteSpam.
	*/

	var dll = "collisions.dll";
	...
	global._c_transform_rotation_quaternion = external_define(dll, "c_transform_rotation_quaternion", calltype, ty_real, 4, ty_real, ty_real, ty_real, ty_real);
	global._c_transform_rotation_axis = external_define(dll, "c_transform_rotation_axis", calltype, ty_real, 4, ty_real, ty_real, ty_real, ty_real);
	...
	global._c_transform_matrix = external_define(dll, "c_transform_matrix", calltype, ty_real, 9, ty_real, ty_real, ty_real, ty_real, ty_real, ty_real, ty_real, ty_real, ty_real);
